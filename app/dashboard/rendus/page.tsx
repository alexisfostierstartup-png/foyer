...
export default async function RendusPage() {
  ...
  const ROOM_LABEL: Record<string, string> = { salon: "Salon", salle_a_manger: "Salle à manger", chambre: "Chambre", chambre_parentale: "Chambre parentale", chambre_enfant: "Chambre enfant" };
