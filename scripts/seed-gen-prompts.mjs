...
${SHARED_RULES}
- Never change, ADD, invent, remove or RELOCATE a wall, window, door, staircase, fireplace, radiator or any structural/architectural feature — reproduce EXACTLY those present in the original photo (same number, same positions, on the SAME walls; e.g. never move the staircase, never add a window). You MAY sensibly complete furniture and decor where the room is out of frame or unclear, but the FIXED architecture stays as in the original. The original room contains EXACTLY these fixed features: {{fixedFeatures}}. Reproduce this exact set (same count, same walls) — add none, remove none. NEVER INVENT ARCHITECTURE: do not add any feature absent from the original — no new window, French door, skylight or glazed opening on a wall that is solid in the original (a solid wall STAYS solid, never turn it into a window); no beams, rafters, coffers, slats or planks on the ceiling if the original ceiling is plain and flat (a plain flat ceiling STAYS plain); no new column, arch, niche, moulding, mantel, fireplace or built-in. Do NOT fill in, wall up, cover or convert an existing opening / passage / doorway into a solid wall, a plant wall, a cabinet or shelving — every opening STAYS a clear walk-through. Keep the room's exact footprint, wall positions, ceiling height and volume — do NOT enlarge, extend, stretch, widen or open up the space. PRESERVE every existing wall recess, inset, alcove, niche, step, return or bulkhead (décaissement) EXACTLY as in the original — do not flatten, fill or square them off. LEAVE ADJACENT SPACES ALONE: do NOT create, furnish, decorate, restyle or invent anything in the room, hallway or outdoor space seen THROUGH a door, doorway, glazed door, window or wall opening — whatever is beyond stays EXACTLY as in the original (same walls, same emptiness). The redesign applies ONLY to the main foreground room. Never place furniture INSIDE a passage or opening (e.g. do not put a TV, unit or shelf inside the doorway/opening to the next room) — an opening stays a clear empty walk-through. Keep room proportions, and LOCK the perspective to the original photo: same viewpoint, same camera position, height and focal length, same vanishing lines — the walls and floor must recede at the EXACT same angles. Do not pan, tilt, rotate, zoom or re-frame the room. Never alter what is visible through a window or glass door. NEVER fill in, cover, build furniture into, shrink, move or remove a door, glazed door (porte-fenêtre) or wall opening / passage to another room — keep every opening EXACTLY as in the original and KEEP IT CLEAR: never place furniture across, in front of, or blocking a door, glazed door or wall opening (they are circulation). You MAY place furniture in front of or under a WINDOW (that is realistic and allowed). If a required piece such as a dressing or wardrobe has no free SOLID wall, make it smaller or omit it — never sacrifice an opening to fit it.
