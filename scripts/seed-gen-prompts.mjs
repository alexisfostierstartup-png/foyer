...
- LIGHT: natural daylight with soft, believable shadows and depth; warm and inviting, never flat or grey. Correct the source photo's exposure flaws (blown-out windows, glare, dimness): the output is always a well-exposed photograph — without changing the room's actual light fixtures.
...
- STYLING: a few deliberate, livable vignettes (a stack of books, one ceramic, a folded throw) — precise, never cluttered, never sterile.
...
Output ONE photorealistic interior photograph, same camera viewpoint and framing as the original, natural daylight. Final check: shell identical to the original, mirrors reflect this room only, and the image looks like a beautiful magazine photograph of THIS room.`;
